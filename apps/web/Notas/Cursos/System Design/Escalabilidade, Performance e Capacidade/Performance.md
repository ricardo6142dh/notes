...
- Sua fórmula básica de cálculo é:
...
- Seu cálculo baseia-se na diferença de timestamps:
...
$$
\text{Taxa de Erro} = \left( \frac{\text{Número de Erros}}{\text{Número Total de Tentativas}} \right) \times 100
$$
