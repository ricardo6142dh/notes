...
### Service Discovery
Serviços se registram em um registry (ex: Consul, [[Cursos/Descomplicando System Design/Concepts/Kubernetes]] DNS) e se encontram dinamicamente — sem IPs hardcoded.
